...
const clientReadiness = [
  ...
  },
  {
    ...
    files: [
      ...
      "clients/hermes/python/src/hermes_membase/cli.py",
      "clients/hermes/python/src/hermes_membase/installer.py",
      "clients/hermes/python/src/hermes_membase/provider.py",
      "clients/hermes/python/src/hermes_membase/plugin/__init__.py",
