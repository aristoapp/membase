...
// Non-blocking refresh: race the API call against a short timeout so plugin
// registration never waits on a slow gateway; the fresh list lands on disk for
// the NEXT boot's tool descriptions.
